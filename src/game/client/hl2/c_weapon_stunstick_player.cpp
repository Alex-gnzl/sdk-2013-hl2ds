...
//			*pOut - 
//-----------------------------------------------------------------------------
void RecvProxy_StunActivePlayer( const CRecvProxyData *pData, void *pStruct, void *pOut )
{
	bool state = *((bool *)&pData->m_Value.m_Int);

	C_WeaponStunStickPlayer *pWeapon = (C_WeaponStunStickPlayer *) pStruct;
...
IMPLEMENT_CLIENTCLASS_DT( C_WeaponStunStickPlayer, DT_WeaponStunStickPlayer, CWeaponStunStickPlayer )
	RecvPropInt( RECVINFO(m_bActive), 0, RecvProxy_StunActivePlayer ),
END_RECV_TABLE()
